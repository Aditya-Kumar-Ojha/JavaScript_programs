...
var ResultObjFilter=obj.filter(function(item){
    return item.val>50;
})

console.log("Objects having val greater than 50 are: ",ResultObjFilter);

var ResultObjMap=obj.map(obj=>{
    // var val=val*val
    return{
        name:obj.name,
        val:obj.val*obj.val
...
{
    item.val=item.val*item.val;return item;
})

console.log("Object with the square of their val: ",ResultObjMap);